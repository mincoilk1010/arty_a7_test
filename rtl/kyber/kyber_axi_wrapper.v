...
module kyber_axi_wrapper (
    ...
    // NEW: shared Keccak bus - pass-through for hash_core_Server inside
    // Kyber_Server S. Client 0 of keccak_shared_arbiter.
    output wire        hash_grant,
    output wire        hash_keccak_init,
    output wire        hash_keccak_init_hard,
    output wire [1:0]  hash_keccak_mode,
    output wire        hash_keccak_wr_en,
    output wire [31:0] hash_keccak_din,
    output wire        hash_keccak_wr_xor,
    output wire        hash_keccak_wr_last,
    output wire        hash_keccak_rd_en,
...
`endif
    ...
    Kyber_Server S (
        ...
        // NEW: shared Keccak bus (pass-through to top)
